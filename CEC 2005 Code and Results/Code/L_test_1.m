...
FES=5000;
for func_num=1
%     if func_num==14 || func_num==17 || (func_num>=19 && func_num<=23)
%         continue;
%     end
    Function_name=strcat('F',int2str(func_num));
...
%  [SMO_gbest,SMO_gbestval,SMO_fitcount]= L_MFO_1(fobj,me,FES,ps,D,lb,ub,func_num);
...
% [SMO_gbest,SMO_gbestval,SMO_fitcount]= CovMFO(fobj,me,FES,ps,D,lb,ub,func_num);
[SMO_gbest,SMO_gbestval,SMO_fitcount]= CCMFO(fobj,me,FES,ps,D,lb,ub,func_num);
% [SMO_gbest,SMO_gbestval,SMO_fitcount]= ALSO(fobj,me,FES,ps,D,lb,ub,func_num);
